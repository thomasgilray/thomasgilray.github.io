...
| **Sep 8, 10**<span class="wk">Week 3</span> | Interpretation. Lexing with derivatives. Grammars. Recursive descent parsing [(slides)](/355/slides/top-down-parsing.pdf). |
| **Sep 15, 17**<span class="wk">Week 4</span> | **Exam 1 is on Tuesday, Sept 15.** It covers Python 3, syntax trees, discrete math, regular expressions, and lexing and parsing.<br>C/C++. The stack and the heap. Pointers. Memory management. |
