...
- [*A Whirlwind Tour of Python*](https://jakevdp.github.io/WhirlwindTourOfPython/), Jake VanderPlas — Python 3 in about a hundred pages, written for people who already program in something else; the notebooks behind it are on [GitHub](https://github.com/jakevdp/WhirlwindTourOfPython)
...
| **Sep 8, 10**<span class="wk">Week 3</span> | Interpretation. Lexing with derivatives. [(lexing exercise)](/355/code/lexing.py){: .aside } |
| **Sep 15, 17**<span class="wk">Week 4</span> | **Exam 1 is on Tuesday, Sept 15** ([view the practice exam](/355/exam1-practice.pdf)). It covers Python 3, syntax trees, discrete math, regular expressions, and lexing.<br>Grammars. Recursive descent parsing. C/C++. The stack and the heap. Pointers. Memory management. [(parsing slides)](/355/slides/top-down-parsing.pdf){: .aside }<br>**Readings:** [*A Tour of C++*](https://isocpp.org/images/uploads/2-Tour-Basics.pdf), Ch. 2, "The Basics." |
...
| **Sep 29, Oct 1**<span class="wk">Week 6</span> | Intro to Rust. Memory safety. Ownership and borrowing. Reference counting and shared environments.<br>**Readings:** [*Rust by Example*](https://doc.rust-lang.org/rust-by-example/), Ch. 1–9, 15 ("Scoping rules"), and 19 ("Std library types"); [*Too Many Lists*](https://rust-unofficial.github.io/too-many-lists/), Ch. 1–2. |
| **Oct 6, 8**<span class="wk">Week 7</span> | Interpreting a Python-like language in Rust.<br>**Exam 2 is on Thursday, Oct 8.** It covers C and C++, Rust, structured and object-oriented programming, polymorphism, memory, ownership and lifetimes, and interpreters.<br>**Readings:** [*Rust by Example*](https://doc.rust-lang.org/rust-by-example/), Ch. 14 ("Generics") and 16 ("Traits"); [*Too Many Lists*](https://rust-unofficial.github.io/too-many-lists/), Ch. 3–4. |
| **Oct 13, 15**<span class="wk">Week 8</span> | Functional programming. S-expressions. Intro to Scheme/Racket. |
| **Oct 20, 22**<span class="wk">Week 9</span> | Scheme/Racket. Meta-circular interpreters. |
| **Oct 27, 29**<span class="wk">Week 10</span> | Closure-creating interpreters.<br>**Exam 3 is on Thursday, Oct 29.** It covers functional programming, Scheme/Racket, and interpreters. |
