...
| **Sep 29, Oct 1**<span class="wk">Week 6</span> | Intro to Rust. Memory safety. Ownership and borrowing. Reference counting and shared environments.<br>**Readings:** [*Rust by Example*](https://doc.rust-lang.org/rust-by-example/), Ch. 1–9, 15, and 19; [*Too Many Lists*](https://rust-unofficial.github.io/too-many-lists/), Ch. 1–2. |
| **Oct 6, 8**<span class="wk">Week 7</span> | Interpreting a Python-like language in Rust.<br>**Readings:** [*Rust by Example*](https://doc.rust-lang.org/rust-by-example/), Ch. 14 and 16; [*Too Many Lists*](https://rust-unofficial.github.io/too-many-lists/), Ch. 3–4.<br>**Exam 2 is on Thursday, Oct 8.** It covers C and C++, Rust, structured and object-oriented programming, polymorphism, memory, ownership and lifetimes, and interpreters. |
