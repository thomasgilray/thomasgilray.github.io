...
| **Sep 15, 17**<span class="wk">Week 4</span> | **Exam 1 is on Tuesday, Sept 15.** It covers Python 3, syntax trees, discrete math, regular expressions, and lexing.<br>Grammars. Recursive descent parsing. C/C++. The stack and the heap. Pointers. Memory management. [(parsing slides)](/355/slides/top-down-parsing.pdf){: .aside } |
