...
| **Oct 6, 8**<span class="wk">Week 7</span> | Interpreting a Python-like language in Rust.<br>**Readings:** [*Rust by Example*](https://doc.rust-lang.org/rust-by-example/), Ch. 14 ("Generics") and 16 ("Traits"); [*Too Many Lists*](https://rust-unofficial.github.io/too-many-lists/), Ch. 3–4.<br>**Exam 2 is on Thursday, Oct 8.** It covers C and C++, Rust, structured and object-oriented programming, polymorphism, memory, ownership and lifetimes, and interpreters. |
